...
namespace EssentialOiltest.Controllers
{
    public class tAdminManagersController : Controller
    {
        ...
        {
            return View(await db.tAdminManager.ToListAsync());
        }
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            tAdminManager tAdminManager = await db.tAdminManager.FindAsync(id);
        ...
        public async Task<ActionResult> Create([Bind(Include = "ManagerId,ManagerPassword,ManagerPasswordSalt,ManagerEmail,ManagerAuth")] tAdminManager tAdminManager)
        {
            ...
            {
                db.tAdminManager.Add(tAdminManager);
        ...
        {
            tAdminManager tAdminManager = await db.tAdminManager.FindAsync(id);
            db.tAdminManager.Remove(tAdminManager);
            await db.SaveChangesAsync();
            return RedirectToAction("Index");
        }
